  ...
  if (user) {
    ...
    authContainer.innerHTML = `
      <div class="user-profile-menu">
        ...
        <button type="button" class="user-logout-btn" onclick="window.authManager.logout(); location.reload();" title="Sair da conta">
    ...
    authContainer.innerHTML = `
      <button type="button" class="btn btn-secondary btn-sm auth-login-btn" onclick="openLoginModal()" style="display: inline-flex; align-items: center; gap: 0.45rem; padding: 0.35rem 0.75rem; min-height: 36px;">
