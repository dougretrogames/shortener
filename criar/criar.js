...
// Abre a tela modal moderna de confirmação de exclusão
function openDeleteModal(slug, onConfirm, customTitle, customMsg) {
  ...
  const msg = customMsg || `Tem certeza de que deseja excluir este link? Esta ação liberará o identificador para novos cadastros e não pode ser desfeita.`;
